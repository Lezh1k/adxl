...
uint16_t execute_read_discrete_inputs(mb_adu_t *adu) {
  return mb_read_bits(adu, m_device->inputDiscreteMap.realAddr);
}
//////////////////////////////////////////////////////////////////////////

uint16_t execute_read_coils(mb_adu_t *adu) {
  return mb_read_bits(adu, m_device->coilsMap.realAddr);
}
//////////////////////////////////////////////////////////////////////////
...
uint16_t execute_read_input_registers(mb_adu_t *adu) {
  return mb_read_registers(adu, m_device->inputRegistersMap.real_addr);
}
//////////////////////////////////////////////////////////////////////////

uint16_t execute_read_holding_registers(mb_adu_t *adu) {
  return mb_read_registers(adu, m_device->holdingRegistersMap.real_addr);
}
//////////////////////////////////////////////////////////////////////////
...
check_discrete_input_address(mb_adu_t *adu) {
  ...
  return m_device && valid_bit_addr(&m_device->inputDiscreteMap, addr);
}
//////////////////////////////////////////////////////////////////////////
...
check_coils_address(mb_adu_t *adu) {
  uint16_t addr = U16_MSBFromStream(adu->data);
  return m_device && valid_bit_addr(&m_device->coilsMap, addr);
}
//////////////////////////////////////////////////////////////////////////
...
check_input_registers_address(mb_adu_t *adu) {
  uint16_t addr = U16_MSBFromStream(adu->data);
  return m_device && valid_register_addr(&m_device->inputRegistersMap, addr);
}
//////////////////////////////////////////////////////////////////////////
...
check_holding_registers_address(mb_adu_t *adu) {
  uint16_t addr = U16_MSBFromStream(adu->data);
  return m_device && valid_register_addr(&m_device->holdingRegistersMap, addr);
}
//////////////////////////////////////////////////////////////////////////
